---
title: RelationshipReactivated - Partner API
description: An event that marks that an app was reactivated.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/RelationshipReactivated'
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/RelationshipReactivated.md
api_name: partner
api_type: graphql
type: object
---
