---
title: OneTimeChargeActivated - Partner API
description: An event that marks that a one-time app charge was activated.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeActivated'
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeActivated.md
api_name: partner
api_type: graphql
type: object
---
