---
title: AppSubscriptionSale - Partner API
description: A transaction corresponding to an app subscription charge.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppSubscriptionSale'
  md: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppSubscriptionSale.md'
api_name: partner
api_type: graphql
type: object
---
