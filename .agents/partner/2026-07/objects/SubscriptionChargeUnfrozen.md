---
title: SubscriptionChargeUnfrozen - Partner API
description: An event that marks that a recurring app charge was unfrozen.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeUnfrozen
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeUnfrozen.md
api_name: partner
api_type: graphql
type: object
---
