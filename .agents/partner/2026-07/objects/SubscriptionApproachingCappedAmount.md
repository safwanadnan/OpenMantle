---
title: SubscriptionApproachingCappedAmount - Partner API
description: An event that marks that a subscription is approaching its capped amount.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionApproachingCappedAmount
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionApproachingCappedAmount.md
api_name: partner
api_type: graphql
type: object
---
