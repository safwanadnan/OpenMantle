---
title: SubscriptionChargeActivated - Partner API
description: An event that marks that a recurring app charge was activated.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeActivated
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeActivated.md
api_name: partner
api_type: graphql
type: object
---
