---
title: OneTimeChargeAccepted - Partner API
description: An event that marks that a one-time app charge was accepted by the merchant.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeAccepted'
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeAccepted.md
api_name: partner
api_type: graphql
type: object
---
