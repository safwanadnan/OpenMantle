---
title: AppUsageSale - Partner API
description: A transaction corresponding to an app usage charge.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppUsageSale'
  md: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppUsageSale.md'
api_name: partner
api_type: graphql
type: object
---
