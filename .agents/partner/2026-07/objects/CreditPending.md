---
title: CreditPending - Partner API
description: An event that marks that an app credit is pending.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/CreditPending'
  md: 'https://shopify.dev/docs/api/partner/2026-07/objects/CreditPending.md'
api_name: partner
api_type: graphql
type: object
---
