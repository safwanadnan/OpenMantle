---
title: SubscriptionChargeFrozen - Partner API
description: >-
  An event that marks that a recurring app charge has been suspended. For
  example,

  if a merchant stops paying their bills, or closes their store, then Shopify

  suspends the recurring app charge.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeFrozen
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/SubscriptionChargeFrozen.md
api_name: partner
api_type: graphql
type: object
---
