---
title: AppSaleCredit - Partner API
description: >-
  A transaction corresponding to an [app
  credit](/docs/admin-api/rest/reference/billing/applicationcredit).
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppSaleCredit'
  md: 'https://shopify.dev/docs/api/partner/2026-07/objects/AppSaleCredit.md'
api_name: partner
api_type: graphql
type: object
---
