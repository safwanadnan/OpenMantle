---
title: OneTimeChargeDeclined - Partner API
description: An event that marks that a one-time app charge was declined by the merchant.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeDeclined'
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/objects/OneTimeChargeDeclined.md
api_name: partner
api_type: graphql
type: object
---
