...
source_url:
  html: >-
    https://shopify.dev/docs/api/partner/2026-07/connections/TransactionConnection
  md: >-
    https://shopify.dev/docs/api/partner/2026-07/connections/TransactionConnection.md
api_name: partner
api_type: graphql
type: connection
---
...
* [transactions](https://shopify.dev/docs/api/partner/2026-07/queries/transactions)
...
* [Transaction​Connection.edges](https://shopify.dev/docs/api/partner/2026-07/connections/TransactionConnection#returns-edges)
* [Transaction​Connection.pageInfo](https://shopify.dev/docs/api/partner/2026-07/connections/TransactionConnection#returns-pageInfo)
